...
{
    public class BemSalvadoType : ObjectGraphType<BemSalvado>
    {
        public BemSalvadoType()
        {
            // Defining the name of the object
            Name = "bemSalvado";

            Field(x => x.IdBemSalvado, nullable: true);
    ...
    public class BemSalvadoInputType : InputObjectGraphType
	{
		public BemSalvadoInputType()
		{
			// Defining the name of the object
			Name = "bemSalvadoInput";
			
            //Field<StringGraphType>("idBemSalvado");
