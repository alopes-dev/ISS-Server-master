...
{
    public class FacultativoResseguroType : ObjectGraphType<FacultativoResseguro>
    {
        public FacultativoResseguroType()
        {
            // Defining the name of the object
            Name = "facultativoResseguro";

            Field(x => x.IdFacultativoResseguro, nullable: true);
    ...
    public class FacultativoResseguroInputType : InputObjectGraphType
	{
		public FacultativoResseguroInputType()
		{
			// Defining the name of the object
			Name = "facultativoResseguroInput";
			
            //Field<StringGraphType>("idFacultativoResseguro");
