...
namespace GraphQL.Server.Transports.AspNetCore
{
        ...
        where TSchema : ISchema
    {
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            // var jsonData = await _distributedCache.GetAsync(gqlRequest.Query);
            // if(!string.IsNullOrEmpty(jsonData))
            // {

            //     var data = new ExecutionResult
            //     {
            //         Data = JsonConvert.DeserializeObject(jsonData)
            //     };
            //     _logger.LogInformation("Chache Hit");

            //     // await WriteResponseAsync(context, writer, data);
            //     return;
            // }

            // _logger.LogInformation("Chache Miss");
            ...
            // Fazer cache de novos dados
            // await _distributedCache.SetAsync(gqlRequest.Query,result.Data);
